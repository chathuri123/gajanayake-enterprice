...
$(document).ready(function() {
 ...
 if(msg.indexOf("ok") >= 0){
     ...
     $("#msg").text("Leasing Company Updated.");
 ...
 {
     $("#msg").text("Leasing Company Not Updated.\n"+msg);
      $(function() {
    $( "#dialog-message" ).dialog({
      modal: true,
      buttons: {
...
<h1 class="entry-title">Edit Leasing Company</h1>
<footer class="clearfix">
	    	</footer><!-- .entry -->
</article>
<div id="respond" class="comment-respond">
    
    <form  id="infrm"  action="EditLeasingCompany1.jsp" method="POST" class="comment-form" >
 ...
 String sql="select * from leasingcompany where LeasingID = '"+id+"'";
 ...
 <input   type='hidden' id="id"  value="<%=rs.getString("LeasingID")%>"   name="id_">
