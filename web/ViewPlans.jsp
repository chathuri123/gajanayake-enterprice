...
ResultSet rs = stmt.executeQuery("select p.PlanID,p.Name,p.NoOfyears,p.LeasingID,p.minDownPayment,p.rate,c.LeasingID,c.Name as Name_ from leasingplans p,leasingcompany c where p.LeasingID=c.LeasingID ");
