<%-- 
    Document   : header
    Created on : Jun 30, 2015, 6:00:49 AM
    Author     : windya yasas
--%>
...
<li id="menu-item-103" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children dropdown menu-item-103">
<a class="dropdown-toggle" data-toggle="dropdown" data-target="#" href="">Spare Parts<b class="caret"></b></a>
<ul class="dropdown-menu">
	<li id="menu-item-94" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-94">
...
<a href="">Update Guarantee Information</a></li>
</ul>
</li>
<li id="menu-item-96" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children dropdown menu-item-96">
...
<a href="AddLeasingCompany.jsp">Add Leasing Company</a></li>
	<li id="menu-item-106" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-106">
<a href="ViewInsuranceCompanies.jsp">View Insurance Companies</a></li>
        	<li id="menu-item-106" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-106">
<a href="ViewPolicies.jsp">View Insurance Policies</a></li>
                	<li id="menu-item-106" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-106">
<a href="ViewLeasingCompanies.jsp">View Leasing Companies</a></li>
                        	<li id="menu-item-106" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-106">
<a href="ViewPlans.jsp">View Leasing Plans</a></li>
